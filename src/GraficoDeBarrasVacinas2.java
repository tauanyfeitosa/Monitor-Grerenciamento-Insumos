...
public class GraficoDeBarrasVacinas2 extends GraficoBase {
    ...
    protected DefaultCategoryDataset createDataset() {
        ...
        try {
            ...
            for (CSVRecord record : parser) {
                ...
                int entrada = Integer.parseInt(record.get("Entrada - Vacinas2"));

                // Obtém a quantidade de saída e converte para inteiro
                int saida = Integer.parseInt(record.get("Saida - Vacinas2"));
    ...
    protected JFreeChart createChart(DefaultCategoryDataset dataset) {
        ...
        JFreeChart chart = ChartFactory.createBarChart(
                "Gráfico de Barras - Entrada e Saída de Vacinas para Adultos e Idosos por Mês", // Título do gráfico
    ...
    protected String getTitulo() {
        ...
        return "Gráfico de Barras - Entrada e Saída de Vacinas para Adultos e Idosos por Mês";
    }
}
