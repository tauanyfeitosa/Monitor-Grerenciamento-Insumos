...
// Classe que estende GraficoBase para criar um gráfico de barras
class GraficoDeBarrasIAB extends GraficoBase {
    ...
    protected DefaultCategoryDataset createDataset() {
        ...
        try {
            ...
            for (CSVRecord record : parser) {
                ...
                int entrada = Integer.parseInt(record.get("Entrada - IAB"));

                // Obtém a quantidade de saída e converte para inteiro
                int saida = Integer.parseInt(record.get("Saida - IAB"));
    ...
    protected JFreeChart createChart(DefaultCategoryDataset dataset) {
        ...
        JFreeChart chart = ChartFactory.createBarChart(
                "Gráfico de Barras - Entrada e Saída de Itens de Atenção Básica por Mês", // Título do gráfico
