...
class GraficoDeBarrasRemedio extends GraficoBase {
    ...
    protected DefaultCategoryDataset createDataset() {
        ...
        try {
            ...
            for (CSVRecord record : parser) {
                ...
                int entrada = Integer.parseInt(record.get("Entrada - Remedios"));

                // Obtém a quantidade de saída e converte para inteiro
                int saida = Integer.parseInt(record.get("Saida - Remedios"));
    ...
    protected JFreeChart createChart(DefaultCategoryDataset dataset) {
        ...
        JFreeChart chart = ChartFactory.createBarChart(
                "Gráfico de Barras - Entrada e Saída de Medicamentos por Mês", // Título do gráfico
