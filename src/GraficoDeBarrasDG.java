...
public class GraficoDeBarrasDG extends GraficoBase {
    ...
    protected DefaultCategoryDataset createDataset() {
        ...
        try {
            ...
            for (CSVRecord record : parser) {
                ...
                int entrada = Integer.parseInt(record.get("Entrada - DG"));

                // Obtém a quantidade de saída e converte para inteiro
                int saida = Integer.parseInt(record.get("Saida - DG"));
    ...
    protected JFreeChart createChart(DefaultCategoryDataset dataset) {
        ...
        JFreeChart chart = ChartFactory.createBarChart(
                "Gráfico de Barras - Entrada e Saída de Insumos de Distribuição Graituita por Mês", // Título do gráfico
    ...
    protected String getTitulo() {
        ...
        return "Gráfico de Barras - Entrada e Saída de Insumos de Distribuição Graituita por Mês";
    }
}
